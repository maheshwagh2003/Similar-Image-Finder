...
if ch:
    ...
    fcol2.image(Image.open("./DATASET/images/" + random_name))
...
if fs:
    ...
    target_vec = vecs[idx]
    fcol2.image(Image.open("./DATASET/images/" + st.session_state["disp_img"]))
    top5 = cdist(target_vec[None , ...] , vecs).squeeze().argsort()[2:8]
    c1.image(Image.open("./DATASET/images/" + names[top5[0]]))
    c2.image(Image.open("./DATASET/images/" + names[top5[1]]))
    c3.image(Image.open("./DATASET/images/" + names[top5[2]]))
    c4.image(Image.open("./DATASET/images/" + names[top5[3]]))
    c5.image(Image.open("./DATASET/images/" + names[top5[4]]))
